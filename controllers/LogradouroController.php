...
require_once(__DIR__ . '/../Dao/LogradouroDao.php');
...
class LogradouroController{
    ...
    public function store(){
        ...
        $camposObrigatorios = ['idUsuario', 'cepLogradouro', 'numLogradouro'];
        ...
        $log = [
            ...
            'cepLogradouro' => $_POST['cepLogradouro'],
            ...
            'ufLogradouro' => $_POST['ufLogradouro'],
            
        ];
    
        try {
            // Insere o usuário no banco de dados
            $logDao = LogradouroDao::insert($log);
            ...
            echo json_encode(['mensagem' => 'Erro ao inserir o logradouro: ' . $e->getMessage()]);
        }
    }
